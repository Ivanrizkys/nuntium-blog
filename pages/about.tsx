  ...
  return (
    <Layout>
      ...
      <div className="bg-black-semi mt-48 text-white relative">
        <div className="bg-white w-2 h-[1068px] top-0 right-[194px] absolute"></div>
        <div className="flex gap-[51px] px-24 pt-36">
          <div className="w-5/12">
            <h2 className="font-libre text-[41px]">We tell stories that drives the heart.</h2>
        ...
        <div className="mx-auto flex flex-col items-center -mt-[7.25rem]">
          <img className="w-full max-w-[557px] relative z-[2]" src="/image/about-2.webp" alt="about-2" />
          <div className="w-full max-w-[524px]">
            <h2 className="font-libre text-[41px] mt-8">We tell the news that makes the most impact.</h2>
        ...
        <div className="w-10/12 ml-auto mt-52">
          <div className="w-full max-w-[612px]">
            <h2 className="font-libre text-[41px]">We share the little moments that shows we’re alive.</h2>
          ...
          <div className="grid grid-cols-3 gap-5 mt-[76px] pb-36">
        ...
        <div className="bg-white w-2 h-[1452px] bottom-0 left-[160px] absolute"></div>
      </div>
